...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    //声明控件
    ImageView nextIv, playIv, lastIv, albumIv,icon;
...
//                从暂停到播放
            ...
            icon.setImageResource(R.drawable.ic_musicbc);
        }
    }
...
//        数据源变化，提示适配器更新
    ...
    private void initView() {
        /* 初始化控件的函数*/
        icon=findViewById(R.id.local_music_bottom_iv_icon);
